...
IAM Platforms: Auth0, Okta, ForgeRock, Azure AD, PingFederate

Protocols: SAML 2.0, OAuth 2.0, OIDC, SCIM, JWT, LDAP

Automation: Python, Flask, PowerShell, Terraform, Docker, AWS, GitHub Actions
